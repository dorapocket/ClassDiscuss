...
(11, '管理学', 'A030102s', '周四第6,7节{第1-16周};周四第8...', 0, 0, 0, 0, 0, '3', '5', 3, 6);
...
(32, 1, 6, 2, 4, 6, 6, 6, '768', '2019-02-27 21:47:57', 'lgy', 0, 1);
...
CREATE TABLE `jb_table` (
  ...
  `DealUser` varchar(20) NOT NULL,
  `DealIP` varchar(20) NOT NULL
...
INSERT INTO `jb_table` (`JBID`, `UserID`, `CommitID`, `Time`, `Deal`, `DealTime`, `DealReason`, `DealUser`, `DealIP`) VALUES
(1, 2, 1, '2019-02-15 19:38:35', 1, '2019-03-02 17:05:32', 'Accept', '', ''),
(2, 2, 2, '2019-02-15 19:39:13', 2, '2019-03-02 17:08:44', 'Delete', '', ''),
(3, 1, 11, '2019-02-17 13:47:38', 0, '0000-00-00 00:00:00', '', '', ''),
(4, 1, 14, '2019-02-17 22:37:47', 0, '0000-00-00 00:00:00', '', '', ''),
(5, 1, 32, '2019-02-27 22:01:57', 2, '2019-03-02 17:29:23', '处理错误', 'admin', ''),
(6, 1, 31, '2019-02-27 22:02:05', 0, '0000-00-00 00:00:00', '', '', ''),
(7, 1, 30, '2019-02-27 22:02:08', 0, '0000-00-00 00:00:00', '', '', ''),
(8, 1, 25, '2019-03-02 17:48:46', 0, '2019-03-02 17:48:46', '', '', '');
...
CREATE TABLE `teacher` (
  `TeacherID` int(11) NOT NULL,
  `WorkNumber` varchar(8) NOT NULL DEFAULT '00000',
...
INSERT INTO `teacher` (`TeacherID`, `WorkNumber`, `TeacherName`, `TeacherSchool`, `Score`) VALUES
(1, '00000', '李国宇', 1, 3.14159),
(2, '00000', '略略略', 3, 8.87542),
(3, '00000', '章天杰', 2, 10),
(4, '00000', '大神', 1, 3.33333),
(5, '00000', 'GYQ', 1, 0),
(6, '40959', '许晓冰', 5, 0);
...
(1, 'admin', 'b7266de79b781f3a62115e522025b0f1', '993549790@qq.com', 1),
...
--
ALTER TABLE `jb_table`
  MODIFY `JBID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
