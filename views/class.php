...
<body class="mdui-theme-primary-indigo mdui-theme-accent-pink">
            ...
            <div class="mdui-col-md-7 mdui-col-offset-md-1 mdui-shadow-9 mdui-col-sm-10 mdui-col-offset-sm-1 basic-col">
                ...
                <div class="mdui-row class-title-container">
                    <div class="mdui-col-md-6 mdui-col-sm-6 mdui-col-xs-8">
                        <h1 class="class-title">高等数学A1</h1>
                        <p class="class-number">选课课号：A0000000</p>
                    </div>
                    <div
                        class="mdui-col-md-3 mdui-col-sm-3 mdui-col-offset-sm-2 mdui-col-xs-4 mdui-col-offset-md-2 class-star-inf">
                ...
                <div class="mdui-row class-basic">
                    <div class="mdui-col-md-12 mdui-col-sm-12 class-info-chip-container">
                        <div class="mdui-chip">
                            <span class="mdui-chip-title"><strong>课程难度：</strong>中等</span>
                        </div>
                        <div class="mdui-chip">
                            <span class="mdui-chip-title"><strong>收获大小：</strong>很大</span>
                        </div>
                        <div class="mdui-chip">
                            <span class="mdui-chip-title"><strong>给分好坏：</strong>超好</span>
                        </div>
                        <div class="mdui-chip">
                            <span class="mdui-chip-title"><strong>作业多少：</strong>很少</span>
                        </div>
                    </div>
                </div>
                <!--课程详细信息-->
                <div class="mdui-row class-info">
                    <div class="mdui-col-md-6 class-num-dis">
                        <p><strong>选课课号：</strong>A0000000</p>
                    </div>
                    <div class="mdui-col-md-6">
                        <p><strong>课程性质：</strong>通识必修课</p>
                    </div>
                    <div class="mdui-col-md-6">
                        <p><strong>开课学院：</strong>理学院</p>
                    </div>
                    <div class="mdui-col-md-6">
                        <p><strong>课程层次：</strong>必修课</p>
                    </div>
                    <div class="mdui-col-md-6">
                        <p><strong>课程学分：</strong>5</p>
                    </div>
                </div>
                <!--按钮组-->
                <div class="mdui-row">
                    <div class="mdui-col-md-12">
                        <div class="class-recommand-button">
                            <button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent"><i
                                    class="mdui-icon material-icons">thumb_up</i>顶</button>
                            <!--<button class="mdui-btn mdui-ripple"><i
                                    class="mdui-icon material-icons">thumb_up</i>已顶</button>-->
                            <button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent"><i
                                    class="mdui-icon material-icons">thumb_down</i>踩</button>
                            <!--<button class="mdui-btn mdui-ripple"><i
                                    class="mdui-icon material-icons">thumb_up</i>已踩</button>-->
                            <button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent"><i
                                    class="mdui-icon material-icons">turned_in_not</i>收藏</button>
                            <!--<button class="mdui-btn mdui-ripple"><i
                                    class="mdui-icon material-icons">thumb_up</i>已收藏</button>-->
                        </div>
                    </div>
                </div>
                <div class="mdui-divider"></div>
                <div class="mdui-row class-teacher-dis">
                    ...
                    <div class="mdui-col-sm-10">
                        <div class="class-dis-star">
                            ...
                            <i class="mdui-icon material-icons">star_half</i>
                            <i class="mdui-icon material-icons">star_border</i>
                            <strong style="font-size:20px;">&nbsp&nbsp7.4</strong></div>
                        <p><strong>姓名：</strong>哈哈哈&nbsp&nbsp&nbsp&nbsp&nbsp<strong>点名率：</strong>0%&nbsp&nbsp&nbsp&nbsp&nbsp<strong>课程好评率：</strong>99%
                        </p>
                        ...
                        <div class="mdui-card mdui-shadow-0 class-commit-body" style="border-radius: 10px;">
                            ...
                            <div class="mdui-card-header">
                                ...
                                <div class="mdui-card-header-subtitle">2019/1/27<div class="commit-star-container">
                                        ...
                                        <i class="mdui-icon material-icons commit-star">star</i>
                                        <i class="mdui-icon material-icons commit-star">star</i>
                                        <i class="mdui-icon material-icons commit-star">star_half</i>
                                        <i class="mdui-icon material-icons commit-star">star_border</i>
                                        <strong>10.0</strong>
                                    </div>
                                </div>
                            </div>
                            <!--评价内容-->
                            <div class="mdui-card-content commit-inner">高数好啊！太好了！我十分喜欢！</div>
            ...
            <div class="mdui-col-md-3 mdui-col-offset-md-1 class-teacher-container mdui-shadow-9 basic-col">
                ...
                <div class="mdui-row">
                    ...
                    <div class="mdui-col-md-12" style="margin-top:20px;">
                        <div class="mdui-divider"></div>
                        <h3 class="class-teacher-subtit">其他老师的《高等数学A1》课</h3>
                    ...
                    <div class="mdui-col-md-12" style="margin-top:20px;">
                        <div class="mdui-divider"></div>
                        <!--该老师的不同课程-->
                        <h3 class="class-teacher-subtit">哈哈哈老师的其他课</h3>
                        <table class="mdui-table mdui-shadow-0 class-subtable">
                            <tbody>
                                <tr>
                                    <td>《线性代数》</td>
    ...
    <div class="mdui-dialog" id="report">
        ...
        <div class="mdui-dialog-actions">
            ...
            <button class="mdui-btn mdui-ripple" mdui-dialog-confirm>举报</button>
        </div>
    </div>
    <!--评价dialog 开始-->
    <div id="dialogcontainer">
        <div id="commitdialog" class="mc-login mdui-dialog">
            ...
            <form action="hhcs.html" method="get" onsubmit="return validate_form(this)" id="commitform">
                ...
                <div class="mdui-textfield mdui-textfield-floating-label" style="margin:0px 20px 10px 20px;">
                    ...
                    <textarea class="mdui-textfield-input" form="commitform" name="committext"
                        onpropertychange="if(value.length>200) value=value.substr(0,200)"></textarea>
                </div>
                <input type="hidden" id="allscore" name="allscore" value="">
                <input type="hidden" id="difficulty" name="difficulty" value="">
                <input type="hidden" id="getsinfo" name="getsinfo" value="">
                <input type="hidden" id="betterscore" name="betterscore" value="">
                <input type="hidden" id="homework" name="homework" value="">
                <div class="centercontainer">
                    <input type="submit" class="mdui-btn mdui-btn-raised mdui-color-theme-accent cmbtn" value="发表">
                </div>
            </form>
            <!--这个js有星星变化、提交检测有没有填完-->
